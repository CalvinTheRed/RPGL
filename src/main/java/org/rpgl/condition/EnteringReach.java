...
/**
 * This Condition is dedicated to determining whether an object is moving into the reach of another object.
 *
 * @author Calvin Withun
 */
public class EnteringReach extends Condition {

    private static final Logger LOGGER = LoggerFactory.getLogger(EnteringReach.class);

    public EnteringReach() {
        super("entering_reach");
    }
