...
public class BaseDamageRollTest {
    ...
    @Test
    @DisplayName("BaseDamageRollTest Subevent throws SubeventMismatchException when subevent type doesn't match")
    ...
    void test3() throws JsonFormatException {
        ...
        Die.queue(10L);
        Die.queue(10L);
        baseDamageRoll.rerollDiceLessThanOrEqualTo(1L, "fire");
    ...
    void test4() throws JsonFormatException {
        ...
        Die.queue(10L);
        Die.queue(10L);
        baseDamageRoll.rerollDiceLessThanOrEqualTo(1L, null);
